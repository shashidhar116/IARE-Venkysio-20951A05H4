public class reverse_of_string_multithreading extends Thread {
    private String sentence;

    public reverse_of_string_multithreading(String sentence) {
